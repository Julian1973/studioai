...
**T45 · UI takes the project from the request** ⏳ OPEN — blocked by T44
...
DoD: the UI runs with `crystal-bears` removed from every .js/.html/.py under cb-studio (grep zero outside tests); Episode 2 opens exactly as EPISODE_2_START_HERE.md describes. Verified.
