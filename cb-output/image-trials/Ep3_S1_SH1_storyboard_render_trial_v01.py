...
'estimateUsd':cost,'candidateCount':1,'state':'prepared'}
...
with B.quote('Ep3',cost,'storyboard-render-trial'):
 ...
 out='shots/Ep3_S1_SH1_storyboard_render_trial_v01.mp4',raw_prompt=True,production_route='cb_render',
...
asset=cb_asset_registry.register_asset(episode='Ep3',scene=1,shot_id='S1.SH1',kind='candidate_take',role='storyboard-render-trial-v01',
 path=output,status='candidate',label='Whole-honeycomb storyboard trial · 30s',source='User-authorised storyboard trial',
