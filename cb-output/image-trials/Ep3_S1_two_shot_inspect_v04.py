...
ROOT=Path(__file__).resolve().parents[2];BASE=ROOT/'cb-output/image-trials';MEDIA=ROOT/'engine/media';P='Ep3_S1_two_shot_trial_v04';n=int(sys.argv[1]);v=MEDIA/'shots'/f'{P}_shot{n}.mp4'
