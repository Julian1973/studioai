...
BASE=ROOT/'cb-output/image-trials';MEDIA=ROOT/'engine/media';P='Ep3_S1_two_shot_trial_v02'
...
Image 1 is the actual final frame of the preceding draft clip: it controls current character world positions, poses, eyelines, purple juice, the EMPTY catapult, and the hanging honeycomb. Its camera composition must change, but its physical state must not.
