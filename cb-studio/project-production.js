...
(() => {
  ...
  function draw(ctx) {
    ...
    const nextRole={see:'keyframes',hear:'voices',watch:'animation'}[next],estimate=ctx.snapshot.services[nextRole]?.estimateUsd*(next==='hear'?shot.dialogue.length:1);
