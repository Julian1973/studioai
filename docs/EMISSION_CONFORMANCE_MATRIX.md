...
| 3 | Character budget | IMPLEMENTED+TESTED — Seedream production word budget hard-blocks after plumbing compaction. | IMPLEMENTED+TESTED — BytePlus recommends under 1,000 English words; compiler targets that and hard-blocks above 1,100 words of transport headroom. | OPEN — emitted V3 request text has no provider character-budget check. |
