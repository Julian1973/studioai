...
def story_context(cast: Iterable[str], episode: str,
    ...
    return {
        ...
        "studioBible": (pathlib.Path(__file__).resolve().parent.parent / "skills/production-standard.md").read_text(encoding="utf-8"),
        "studioBibleProvenance": "Locked historical source retained for lineage; runtime workflow follows the current production standard.",
        "characters": selected,
