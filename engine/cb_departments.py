...
def prepare_cinematography(context, images, *, log=print):
    ...
    user = (
        ...
        "explicit empty-space reservations, such as 'Hold empty space frame-right for the "
        "character entering later'; never fill planned reveal space merely to balance the frame. The "
