...
def build_scene_post(shots, out_root, episode, scene_num, input_signature,
    ...
    try:
        ...
        manifest = {
            ...
            "sourceRecords": {'shots':[{'id':s['shotId'], 'path':s['approvedTake'],
                'sha256':_sha256(s['approvedTake']),
                'requestLineage':s.get('requestLineage', {'status':'legacy-unverified'})} for s in shots]},
