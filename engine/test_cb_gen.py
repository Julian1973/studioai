...
def test_billing_profile_is_the_pricing_source():
    ...
    assert prof["planConfirmed"] is False and prof["cadenceConfirmed"] is False
...
def test_billing_record_carries_every_required_field():
    ...
    assert rec["planConfirmed"] is False and rec["cadenceConfirmed"] is False
    ...
    assert "UNCONFIRMED" in rec["costBasis"] and "ex tax" in rec["costBasis"]
