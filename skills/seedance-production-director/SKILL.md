...
description: Direct approved script, canon, opening-frame, reference, audio and continuity inputs into compact cinematic Seedance shooting scripts.
metadata:
  author: Julian Jenkins — cre8tive
  version: 1.0.0
